...
parametric = 2;                                 % 0 for single simulation, 1 for parametric analysis, 2 for IK analysis
...
elseif par.parametric == 2 % test with or without IK
  result = comparison_IK(user_par, variable_param, par);
else
...
if par.parametric == 1 || par.parametric == 0
  plot_chutes_trajectory(chute, true_centroid_store, j_fig, w_store, par, post_process_data, par.parametric);
